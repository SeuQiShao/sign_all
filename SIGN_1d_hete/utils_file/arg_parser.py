...
def parse_args():
    ...
    parser.add_argument('--network', type=str,
                    choices=['random', 'power_law', 'small_world','from_file'], default='power_law')
    ...
    parser.add_argument('--init_noise', type=float, default=0.03, help="dist of omega")
    ...
    args.root = '/data/scratch/acw802/SIGN_1d_hete/SIGN_data/{}_{}_{}_{}_{}_{}'.format(args.ode_model, args.num_atoms, args.network, args.time_interval, args.time_stamp, args.init_noise)
