...
def parse_args():
    ...
    ############## GSI hyperparameter ##############
    parser.add_argument(
        "--poly_p", type=int, default=6, help="Polynomial of Library."
    )
    parser.add_argument(
        "--poly_n", type=int, default=10, help="Neg_Polynomial of Library."
    )
    parser.add_argument(
    ...
    parser.add_argument("--teacher", type=int, default=400, help="add teacher every t.")
    ...
    parser.add_argument(
        "--l1_epochs", type=int, default=200, help="Number of epochs to train."
    )
    parser.add_argument(
    ...
    parser.add_argument('--ode_model', type=str,
                    choices=['HeatDiffusion', 'Kuramoto','Gene','Mutual'], default='Gene')
