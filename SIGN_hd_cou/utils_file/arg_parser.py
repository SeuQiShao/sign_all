...
def parse_args():
    ...
    parser.add_argument('--stre', type=float, default=1, help='coupling strength')
    ...
    args.suffix = '{}_{}_{}_{}_{}_{}'.format(args.ode_model, args.num_atoms, args.network, args.time_interval, args.time_stamp, args.stre)
    args.root = '/data/scratch/acw802/SIGN_hd_cou/SIGN_data/{}_{}_{}_{}_{}_{}'.format(args.ode_model, args.num_atoms, args.network, args.time_interval, args.time_stamp, args.stre)
