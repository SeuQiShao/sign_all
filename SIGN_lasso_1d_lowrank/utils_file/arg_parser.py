...
def parse_args():
    ...
    parser.add_argument('--network', type=str,
                    choices=['random', 'power_law', 'small_world', 'from_file', 'rpg', 'sbm', 'dscm', 'rgm'], default='rpg')
    parser.add_argument('--ode_model', type=str,
                    choices=['SIS', 'Kuramoto', 'Gene'], default='Gene')
    ...
    args.root = '/data/scratch/acw802/SIGN_lasso_1d_lowrank/SIGN_data/{}_{}_{}_{}_{}'.format(args.ode_model, args.num_atoms, args.network, args.time_interval, args.time_stamp)
