...
import argparse
from model.utils import get_edgeindex_4_edges, generate_missing_edges
...
def get_args():
    ...
    parser.add_argument('--miss_edge_rate', type=float, default=0.4, help='observased node rate')
