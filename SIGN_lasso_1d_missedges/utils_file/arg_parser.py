...
def parse_args():
    ...
    args.root = '/data/home/acw802/demo_try/HiSIGN/SIGN_original/SIGN_lasso_1d_missedges/SIGN_data/{}_{}_{}_{}_{}_{}'.format(args.ode_model, args.num_atoms, args.network, args.time_interval, args.time_stamp, args.miss_edge_rate)
