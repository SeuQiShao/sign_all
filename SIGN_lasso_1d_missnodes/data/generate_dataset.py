...
def get_args():
    ...
    parser.add_argument('--ob_node_rate', type=float, default=0.85, help='observased node rate')
    ...
    # 图结构参数
    parser.add_argument('--node_num', type=int, default=100000, help='Number of nodes in the graph')
    ...
    parser.add_argument('--init_scale', type=float, default=0.01, help='Scale factor for initial state values')
