...
class GSICell(MessagePassing):
    def __init__(self, args):
        ...
        ########### 公共参数 #############
        self.ploy_p = args.poly_p
        self.ploy_n = args.poly_n
    ...
    def forward(self, t, x, batchs):
        ...
        # 计算F部分
        with torch.no_grad():
            F_msg = utils.fun_lib(x, self.ploy_p, self.ploy_n, 
    ...
    def message(self, x_i, x_j, edge_attr, wc_1):
        ...
        # 生成耦合项基函数
        with torch.no_grad():
            C_msg = utils.coupled_fun_lib(x_i, x_j, self.ploy_p, self.ploy_n,
