...
def parse_args():
    ...
    args.root = '/data/scratch/acw802/SIGN_lasso_1d_obnoise/SIGN_data/{}_{}_{}_{}_{}_{}'.format(args.ode_model, args.num_atoms, args.network, args.time_interval, args.time_stamp, args.obnoise)
