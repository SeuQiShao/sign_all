...
def parse_args():
    ...
    parser.add_argument("--teacher", type=int, default=30, help="add teacher every t.")
    ...
    parser.add_argument(
        "--l1_epochs", type=int, default=20, help="Number of epochs to train."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--lr", type=float, default=0.02, help="Initial learning rate."
    )
    parser.add_argument(
        "--lr_decay",
        type=int,
    ...
    parser.add_argument('--network', type=str,
                    choices=['random', 'power_law', 'small_world','oregon', 'git', 'Twitch', 'email', 'CA'], default='small_world')
    parser.add_argument('--ode_model', type=str,
                    choices=['HeatDiffusion', 'Kuramoto', 'Mutual', 'Gene', 'Rossler'], default='Fitz')
