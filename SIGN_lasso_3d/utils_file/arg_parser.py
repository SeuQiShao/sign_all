...
def parse_args():
    ...
    parser.add_argument(
        "--poly_n", type=int, default=1, help="Neg_Polynomial of Library."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--tri", type=bool, default=False, help="activation of Library."
    )



    parser.add_argument("--teacher", type=int, default=2, help="add teacher every t.")
    ...
    parser.add_argument('--network', type=str,
                    choices=['random', 'power_law', 'small_world','oregon', 'git', 'Twitch', 'email', 'CA', 'deezer'], default='small_world')
    parser.add_argument('--ode_model', type=str,
                    choices=['HeatDiffusion', 'Kuramoto', 'Mutual', 'Gene', 'Rossler', 'Fitz', 'HR'], default='HR')
    parser.add_argument('--time_stamp', type=int, default=800, help="number of timesteps.")
    parser.add_argument('--num_atoms', type=int, default=100000)# 10670 37700 168114 36692 23133 28281 
