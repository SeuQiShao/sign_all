...
import argparse
from model.utils import get_edgeindex_4_edges, partition_graph_pyg, generate_rpg, generate_dscm, generate_rgm, generate_sbm
...
def get_args():
    ...
    parser.add_argument('--save_path', type=str, default='/data/scratch/acw802/SIGN_lasso_hd_lowrank/SIGN_data', help='Path to save the generated data')
    ...
    parser.add_argument('--network', type=str, choices=['random', 'power_law', 'small_world', 'from_file', 'rpg', 'sbm', 'dscm', 'rgm'],
                         default='rpg', help='Type of graph topology to use')#network files: github/musae_git_edges.csv, bn-fly/bn-fly-drosophila_medulla_1.edges, bn-human-BNU_1_0025890_session_178k/bn-human-BNU_1_0025890_session_1.edges
