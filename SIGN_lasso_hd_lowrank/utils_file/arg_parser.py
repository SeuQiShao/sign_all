...
def parse_args():
    ...
    args.root = '/data/scratch/acw802/SIGN_lasso_hd_lowrank/SIGN_data/{}_{}_{}_{}_{}'.format(args.ode_model, args.num_atoms, args.network, args.time_interval, args.time_stamp)
