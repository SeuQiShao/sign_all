...
def parse_args():
    ...
    parser.add_argument('--ode_model', type=str,
                    choices=['FHN', 'HR', 'Rossler'], default='Rossler')
    ...
    parser.add_argument('--miss_edge_rate', type=float, default=0.1, help='observased node rate')
    ...
    args.suffix = '{}_{}_{}_{}_{}_{}'.format(args.ode_model, args.num_atoms, args.network, args.time_interval, args.time_stamp, args.miss_edge_rate)
    args.root = '/data/home/acw802/demo_try/HiSIGN/SIGN_original/SIGN_lasso_hd_missedges/SIGN_data/{}_{}_{}_{}_{}_{}'.format(args.ode_model, args.num_atoms, args.network, args.time_interval, args.time_stamp, args.miss_edge_rate)
