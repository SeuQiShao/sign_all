...
import argparse
from model.utils import get_edgeindex_4_edges, partition_graph_pyg, sample_observed_dynamics
...
def get_args():
    ...
    parser.add_argument('--ob_node_rate', type=float, default=0.99, help='observased node rate')
