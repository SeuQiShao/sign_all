...
def parse_args():
    ...
    parser.add_argument('--num_atoms', type=int, default=900) #37700 1686
    ...
    args.root = '/data/home/acw802/demo_try/HiSIGN/SIGN_original/SIGN_lasso_hd_missnodes/SIGN_data/{}_{}_{}_{}_{}'.format(args.ode_model, args.num_atoms, args.network, args.time_interval, args.time_stamp)
