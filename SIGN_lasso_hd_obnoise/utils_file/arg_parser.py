...
def parse_args():
    ...
    parser.add_argument('--obnoise', type=int, default=30)
    ...
    args.suffix = '{}_{}_{}_{}_{}_{}'.format(args.ode_model, args.num_atoms, args.network, args.time_interval, args.time_stamp, args.obnoise)
    args.root = '/data/scratch/acw802/SIGN_lasso_hd_obnoise/SIGN_data/{}_{}_{}_{}_{}_{}'.format(args.ode_model, args.num_atoms, args.network, args.time_interval, args.time_stamp, args.obnoise)
