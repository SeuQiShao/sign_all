...
def parse_args():
    ...
    parser.add_argument(
        "--k_num", type=int, default=12, help="Fourier basis number."
    )
    parser.add_argument(
        "--five_points", type=bool, default=False, help="estimate diffs with five points."
    ) #enso = False

    parser.add_argument("--teacher", type=int, default=500, help="add teacher every t.")
    ...
    args.root = '/data/scratch/acw802/SIGN_lasso_true/SIGN_data/{}_{}'.format(args.ode_model, args.num_atoms)
