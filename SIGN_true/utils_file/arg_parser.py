...
def parse_args():
    ...
    parser.add_argument(
        "--t_basis", type=bool, default=True, help="t function of Library."
    )


    parser.add_argument("--teacher", type=int, default=807, help="add teacher every t.")
    ...
    parser.add_argument(
        "--l1_epochs", type=int, default=1000, help="Number of epochs to train."
    )
    parser.add_argument(
        "--batch_size", type=int, default=1, help="Number of samples per batch."  # default=32
    )
    ...
    parser.add_argument("--norm", type=bool, default=True, help="lambda of similarity.")
    parser.add_argument(
    ...
    parser.add_argument('--ode_model', type=str,
                    choices=['tb','climate','enso'], default='enso') #climate_17848
    parser.add_argument('--time_stamp', type=int, default=120, help="number of timesteps.") #511 867
    parser.add_argument('--noise', type=float, default=0, help="noise.")
    parser.add_argument('--coupled', type=float, default=0.1, help="coupled.")
    parser.add_argument('--num_atoms', type=int, default=7995) # 17848 8400 13440 22940 7995
    ...
    args.root = '/home/shaoqi/code/SIGN_all/SIGN_data/' + args.ode_model +'_' + str(args.num_atoms)
